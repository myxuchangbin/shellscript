...
if [ -f ${plugin_file} ];then
    ...
    wget https://raw.githubusercontent.com/myxuchangbin/shellscript/refs/heads/master/btpanel/plugin.json
    chattr +i /www/server/panel/data/plugin.json
fi
echo "插件商城优化结束."
...
if [ -f ${repair_file} ];then
    ...
    wget https://raw.githubusercontent.com/myxuchangbin/shellscript/refs/heads/master/btpanel/repair.json -O /www/server/panel/data/repair.json
    chattr +i /www/server/panel/data/repair.json
else
    cd /www/server/panel/data
    wget https://raw.githubusercontent.com/myxuchangbin/shellscript/refs/heads/master/btpanel/repair.json
    chattr +i /www/server/panel/data/repair.json
fi
echo -e "文件防修改结束."
